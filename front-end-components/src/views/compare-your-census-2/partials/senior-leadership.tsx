...
import { SeniorLeadershipData } from "src/views/compare-your-census-2/partials";
...
export const SeniorLeadership: React.FC<{
  ...
  const [data, setData] = useState<SeniorLeadershipData[] | null>();
  ...
  useEffect(() => {
    const merged = censusData
      ? censusData.reduce<SeniorLeadershipData[]>(
          (acc: SeniorLeadershipData[], curr: Census) => {
            acc.push({
              ...curr,
