...
import {
    ...
    Total, HorizontalBarChartWrapper, WorkforceCategories
} from "src/components";
...
export const AuxiliaryStaff: React.FC<AuxiliaryStaffProps> = (props) => {
    ...
    return (
        <ChartDimensionContext.Provider value={dimension}>
            <HorizontalBarChartWrapper data={chartData} chartId="auxiliary-staff">
                <h2 className="govuk-heading-m">Auxiliary staff (Full Time Equivalent)</h2>
