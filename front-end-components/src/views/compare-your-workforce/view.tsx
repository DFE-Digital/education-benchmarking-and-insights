...
import {
    ...
    NonClassroomSupport,
    SchoolWorkforce,
    SeniorLeadership, TeachingAssistants,
    TotalTeachers,
    ...
    return (
        <SelectedSchoolContext.Provider value={selectedSchool}>
            ...
            <ChartModeContext.Provider value={displayMode}>
                <SchoolWorkforce schools={workforceData ? workforceData.results : new Array<Workforce>()}/>
                <TotalTeachers schools={workforceData ? workforceData.results : new Array<Workforce>()}/>
                <TotalTeachersQualified schools={workforceData ? workforceData.results : new Array<Workforce>()}/>
                <SeniorLeadership schools={workforceData ? workforceData.results : new Array<Workforce>()}/>
                <TeachingAssistants schools={workforceData ? workforceData.results : new Array<Workforce>()}/>
                <NonClassroomSupport schools={workforceData ? workforceData.results : new Array<Workforce>()}/>
                <AuxiliaryStaff schools={workforceData ? workforceData.results : new Array<Workforce>()}/>
                <Headcount schools={workforceData ? workforceData.results : new Array<Workforce>()}/>
