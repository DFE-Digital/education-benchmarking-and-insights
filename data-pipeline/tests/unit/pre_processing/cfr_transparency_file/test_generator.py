...
import numpy as np
import pytest
from pipeline.pre_processing.cfr.transparency_file.generator import build_transparency_files
...
def test_build_transparency_files_structure():
    ...
    all_cols = [
        "LANumber", "LEAEstab", "Estab", "Federated Flag",
        "LAEstab of School in Federation 1", "LAEstab of School in Federation 2",
        "LAEstab of School in Federation 3", "LAEstab of School in Federation 4",
        "LAEstab of School in Federation 5", "LAEstab of School in Federation 6",
        "LAEstab of School in Federation 7", "LAEstab of School in Federation 8",
        "LAEstab of School in Federation 9", "LAEstab of School in Federation 10",
        ...
        "E28a", "E28b", "E29", "E30", "E31", "E32",
        "OB01", "OB02", "OB03", "CI01", "CI03", "CI04", "CE01", "CE02", "CE03", 
        "CE04A", "CE04B", "CE04C", "CE04D", "CE04E", "B01", "B02", "B03", "B05", "B06", "B07"
    ]
    
    header = ",".join(all_cols)
    row1 = ["100", "1001001", "1001", "No"] + ["0"] * 10 + ["1000"] * (len(all_cols) - 14)
    row2 = ["100", "1001002", "1002", "Yes"] + ["1001003"] + ["0"] * 9 + ["2000"] * (len(all_cols) - 14)
    ...
    hospital_schools = pd.DataFrame(columns=["LAEstab", "GHSIndicator", "TotalHeadcount"]).astype({
        "LAEstab": "Int64",
        "GHSIndicator": "string",
    ...
    census = pd.DataFrame({
        ...
        "number of pupils known to be eligible for free school meals": [20, 40, 10],
        "number of pupils whose first language is known or believed to be other than English": [5, 10, 2],
    ...
    expected_order = [
        "LA", "LA Name", "Estab", "LAEstab", "Did Not Supply flag", "Lead school in federation",
        "London Weighting", "No pupils", "Overall Phase", "% of pupils eligible for FSM",
        "% of pupils with SEN support", "% of pupils with EHCP", "School Name",
        "FTE Number of teachers", "Number of pupils in 6th form", "Type", "URN",
        "Admissions policy", "Period covered by return", "Federated submission",
        "I01 Funds delegated by the LA", "I02 Funding for 6th form students",
        "I01/2 Total pre and Post-16 Funding", "I03 SEN funding", "I04 Funding for minority ethnic pupils",
        "I05 Pupil premium", "I06 Other government grants", "I07 Other grants and payments",
        "I08a Income from lettings", "I08b Income from facilities and services",
        "I08a/b Total income from facilities and services", "I09 Income from catering",
        "I10 Receipts from supply teacher insurance claims", "I11 Receipts from other insurance claims",
        "I12 Income from contributions to visits etc.", "I13 Donations and/or private funds",
        ...
        "E07 Cost of other staff", "E08 Indirect employee expenses", "E09 Development and training",
        ...
        "E20F Other hardware", "E20G IT support", "E21 Exam fees", "E22 Administrative supplies",
        "E23 Other insurance premiums", "E24 Special facilities", "E25 Catering supplies",
        "E26 Agency supply teaching staff", "E27 Bought in professional services – curriculum",
        "E28a Bought in professional services, other, not PFI",
        "E28b Bought in professional services, other, PFI",
        "E28a/b Total bought in professional services", "E29 Loan interest",
        ...
        "CE04A Connectivity", "CE04B Onsite servers", "CE04C Administration software and systems",
        "CE04D Laptops desktops and tablets", "CE04E Other hardware", "B01 Committed revenue balances",
        "B02 Uncommitted revenue balances", "B03 Devolved formula capital balance",
        "B05 Other capital balances", "B06 Community-focused school revenue balances",
        "B07 Outstanding balance on capital loans to school", "Revenue Reserve: B01 + B02 + B06",
        ...
        "Self Generated Funding: (I08a/b:I13) + I17", "Total Income: I01:I18 - E30",
        "Teaching Staff E01", "Supply Staff: E02 + E10 + E26", "Education support staff: E03",
        ...
        "Brought in Professional Services: (E27 + E28a)", "Community Exp: E31 + E32",
