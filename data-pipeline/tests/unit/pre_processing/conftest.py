    ...
    return pd.DataFrame(
        {
            "URN": [100150, 100152, 100153],
            "LA": [865, 845, 929],
            "Estab": [5411, 4026, 4002],
            "ACADEMYUPIN": [111443, 111451, 111453],
            "ACADEMYTRUSTSTATUS": ["Existing", "Closed", "Existing"],
            "Company_Number": ["8146633", "8075785", "8146633"],
            ...
            "BNCH11123-BAI011-A (Academies - Income)": [1000, 1001, 1002],
            ...
            "BNCH11000T (Revenue Income)": [1000, 1001, 1002],
            "BNCH20000T (Total Costs)": [500, 1001, 1003],
    ...
    return pd.DataFrame(
        {
            ...
            "BNCH21601 (Learning resources (not ICT equipment))": [1000, 1001, 1002],
            "BNCH11000T (Revenue Income)": [1000, 1001, 1002],
            "BNCH20000T (Total Costs)": [1000, 1001, 1002],
            "BNCH21104 (Administrative and clerical staff)": [1000, 1001, 1002],
            "BNCH21703 (Auditor costs)": [1000, 1001, 1002],
            "BNCH21107 (Other staff)": [1000, 1001, 1002],
