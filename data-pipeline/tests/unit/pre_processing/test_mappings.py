...
@pytest.mark.parametrize("code,provision,expected", [
    (pd.NA, pd.NA, None),
    (pd.NA, "Special", None),
    (38, pd.NA, None),
    (33, "Special", "Special"),
...
@pytest.mark.parametrize("block_age,expected", [
    ("", None),
    ("pre 1900", 1880),
    ("1990-2000", 1995),
    ("2000-2010", 2005)
...
@pytest.mark.parametrize("boarder,expected", [
...
@pytest.mark.parametrize("sixth_form,expected", [
...
@pytest.mark.parametrize("nursery,provision,expected", [
...
@pytest.mark.parametrize("nursery,expected", [
...
@pytest.mark.parametrize("admission_policy,expected", [
    ("Selective", "Selective"),
...
@pytest.mark.parametrize("opened_in_period,closed_in_period,valid_to,start_date,closed_date,period_start,year_start_date,year_end_date,expected", [
    (pd.NA, pd.NA, pd.NA, pd.NA, pd.NA, "10/09/2019", "01/09/2019", "30/08/2020", None),
    (pd.NA, pd.NA, pd.NA, "01/06/2018", "01/08/2019", "10/09/2019", "01/09/2019", "30/08/2020", "Closed"),
    (pd.NA, pd.NA, pd.NA, "01/06/2018", "30/08/2020", "10/09/2019", "01/09/2019", "30/08/2020", "Closed in period"),
    (pd.NA, pd.NA, pd.NA, "01/06/2018", "01/11/2019", "10/09/2019", "01/09/2019", "30/08/2020", "Closed in period"),
    (pd.NA, pd.NA, pd.NA, "20/09/2019", pd.NA, "10/09/2019", "01/09/2019", "30/08/2020", "(Re)opened in period"),
    ("25/09/2019", pd.NA, pd.NA, "01/06/2018", pd.NA, "10/09/2019", "01/09/2019", "30/08/2020", "(Re)opened in period"),
    (pd.NA, pd.NA, pd.NA, "01/06/2018", pd.NA, "10/09/2019", "01/09/2019", "30/08/2020", "Open"),
    (pd.NA, pd.NA, "05/09/2019", "01/06/2018", pd.NA, "10/09/2019", "01/09/2019", "30/08/2020", "Invalid"),
])
def test_map_academy_status(opened_in_period,
                            closed_in_period,
                            valid_to,
                            start_date,
                            closed_date,
                            ...
                            year_end_date,
                            expected):
    assert mappings.map_academy_status(
        ...
        pd.to_datetime(year_end_date, dayfirst=True)) == expected


@pytest.mark.parametrize("start_date,closed_date,return_period_length,year_start_date,year_end_date,expected", [
...
def test_map_maintained_school_status(start_date,
                                      closed_date,
                                      return_period_length: int,
                                      year_start_date,
                                      year_end_date,
                                      expected):
    assert mappings.map_maintained_school_status(
...
@pytest.mark.parametrize("pfi,expected", [
...
@pytest.mark.parametrize("establishment_code,phase_type,expected", [
    (33, pd.NA, None),
    (33, "Primary", "Special"),
    (36, "Primary", "Special"),
    (44, "Primary", "Special"),
