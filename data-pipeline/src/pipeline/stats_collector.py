...
class StatsCollector:
    ...
    def collect_aar_academy_counts(self, aar_academies_data_preprocessed, aar_year) -> None:
    ...
    def collect_cfr_la_maintained_school_counts(self, la_maintained_schools_data_preprocessed, cfr_year) -> None:
    ...
    def collect_combined_school_counts(self, combined_schools_data_preprocessed) -> None:
    ...
    def _collect_preprocessed_ancillary_data_shapes(
        ...
        self.stats["financial_data"][school_category]["ancillary_data"]["year"] = ancillary_data_year
        for ancillary_data_name, ancillary_data_df in ancillary_data_dict.items():
            if ancillary_data_df is not None:
                ...
                self.stats["financial_data"][school_category]["ancillary_data"][ancillary_data_name] = row_count
    
    def collect_aar_ancillary_data_shapes(self, aar_ancillary_data, aar_year) -> None:
        self._collect_preprocessed_ancillary_data_shapes("academies", aar_ancillary_data, aar_year)

    def collect_cfr_ancillary_data_shapes(self, cfr_ancillary_data, cfr_year) -> None:
        self._collect_preprocessed_ancillary_data_shapes("la_maintained_schools", cfr_ancillary_data, cfr_year)
