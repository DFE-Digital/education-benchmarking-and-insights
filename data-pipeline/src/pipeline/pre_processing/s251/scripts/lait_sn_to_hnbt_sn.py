...
df_names = df_original.pivot(index=["old_la_code"], columns="SN", values="SN_name")
...
df_prox = df_original.pivot(index=["old_la_code"], columns="SN", values="SN_prox")
...
df_codes = df_original.pivot(index=["old_la_code"], columns="SN", values="old_la_code2")
...
df_final.to_excel(
    "~/Documents/dfe-fbit/2025/High-needs-local-authority-benchmarking-tool.xlsx",
    index=False,
