...
def add_financials(merged: pd.DataFrame) -> pd.DataFrame:
    ...
    m["I08a/b Income from facilities and services"] = m[["I08a", "I08b"]].sum(axis=1)
    ...
    m["I18 Total additional grant for schools"] = m[["I18c", "I18d"]].sum(axis=1)
    ...
    m["E28a/b Bought in professional services"] = m[["E28a", "E28b"]].sum(axis=1)
    ...
    m["Grant Funding: (I01:I07) + I15 + I16 + I18a/b/c/d"] = m[
