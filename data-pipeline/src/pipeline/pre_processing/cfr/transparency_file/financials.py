...
def add_financials(merged: pd.DataFrame) -> pd.DataFrame:
    ...
    m["E30 Direct revenue financing (Revenue contributions to capital)"] = get_val(
        "E30"
    )
    ...
    m["CE04 Information and communication technology"] = (
        ...
        if all(c in m.columns for c in ["CE04A", "CE04B", "CE04C", "CE04D", "CE04E"])
        else 0
    )
    ...
    m["Revenue Reserve: B01 + B02 + B06"] = (
        get_val("B01") + get_val("B02") + get_val("B06")
    )
    ...
    expense_net = expense_total - (
        get_val("I09") + get_val("I10") + get_val("I16") + get_val("I17")
    )
    ...
    m["Direct Grants: I01:I02 + I06:I07"] = (
        get_val("I01") + get_val("I02") + get_val("I06") + get_val("I07")
    )
    m["Community Grants: I16+I18"] = get_val("I16") + get_val("I18c") + get_val("I18d")
    m["Targetted Grants: I03:I05 + I15"] = (
        get_val("I03") + get_val("I04") + get_val("I05") + get_val("I15")
    )
    ...
    m["Supply Staff: E02 + E10 + E26"] = (
        get_val("E02") + get_val("E10") + get_val("E26")
    )
    m["Education support staff: E03"] = get_val("E03")
    m["Other Staff Costs: (E07:E09) + E11"] = (
        get_val("E07") + get_val("E08") + get_val("E09") + get_val("E11")
    )
    ...
    m["Brought in Professional Sevices: (E27 + E28a)"] = get_val("E27") + get_val(
        "E28a"
    )
