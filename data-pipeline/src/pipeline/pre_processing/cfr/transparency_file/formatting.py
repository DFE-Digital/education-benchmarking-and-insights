...
from pipeline.input_schemas.maintained_schools_master_list import master_list_mappings

from .transparency_file_schema import download_file_mappings
...
def build_maintained_schools_master_list(
    ...
    fin_mappings = master_list_mappings.get(year, master_list_mappings["default"])
...
def build_maintained_schools_download_file(
    ...
    fin_mappings = download_file_mappings.get(year, download_file_mappings["default"])
