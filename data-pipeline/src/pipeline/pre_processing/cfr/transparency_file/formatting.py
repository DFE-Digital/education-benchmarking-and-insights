...
from .transparency_file_schema import get_transparency_file_schema
from pipeline.input_schemas import get_master_list_mappings
...
def build_maintained_schools_master_list(sfb: pd.DataFrame, year: int = 2025) -> pd.DataFrame:
    ...
    fin_mappings = get_master_list_mappings(year)
...
def build_maintained_schools_download_file(sfb: pd.DataFrame, year: int = 2025) -> pd.DataFrame:
    ...
    fin_mappings = get_transparency_file_schema(year)
