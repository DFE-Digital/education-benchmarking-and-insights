...
def run_laa_risk_scores_pipeline(run_year: int, run_id: str):
    ...
    risk_metrics_with_raw_data, melted_indicators_df, melted_headers_df = derive_laa_risk_scores(
    ...
    create_laa_risk_scores_download_file(risk_metrics_with_raw_data)
