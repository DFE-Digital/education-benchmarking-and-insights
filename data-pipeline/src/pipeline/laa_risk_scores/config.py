...
DEFAULT_RISK_CONFIG: list = [
    ...
    PercentExpenditureOnStaffMetric(
        ...
        rules=[
            ...
            MetricRule(0.95, 1000000, 1.5, RiskFlag.MINOR.value, "left"),
        ],
    ),
    ...
    OverspendMetric(
        ...
        rules=[
            ...
            MetricRule(-0.080, -0.075, 2.5, RiskFlag.MAJOR.value, "left"),
            MetricRule(-0.075, -0.06, 2.0, RiskFlag.MAJOR.value, "left"),
            MetricRule(-0.060, -0.05, 1.75, RiskFlag.MAJOR.value, "left"),
            MetricRule(-0.050, -0.04, 1.25, RiskFlag.MINOR.value, "left"),
            MetricRule(-0.040, -0.025, 1.0, RiskFlag.MINOR.value, "left"),
            MetricRule(-0.025, -0.01, 0.5, RiskFlag.MINOR.value, "left"),
            MetricRule(-0.001, 0.0, 0.25, RiskFlag.MINOR.value, "left"),
    ...
    PupilNumberVarianceFromCapacityMetric(
        ...
        rules=[
            ...
            MetricRule(0.45, 0.50, 1.0, RiskFlag.MAJOR.value, "left"),
            MetricRule(0.50, 0.55, 0.75, RiskFlag.MINOR.value, "left"),
            MetricRule(0.55, 0.60, 0.6, RiskFlag.MINOR.value, "left"),
    ...
    ParentalPreferenceMetric(
        ...
        standard_rules=[
            ...
            MetricRule(0.70, 0.75, 0.8, RiskFlag.MINOR.value, "left"),
    ...
    PerformanceTablesAchievementScoreMetric(
        ...
        rules=[
            ...
            MetricRule(46, 100, 0.0, RiskFlag.NONE.value, "left"),
        ],
    ),
]
