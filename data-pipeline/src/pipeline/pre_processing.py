...
def _slope_analysis(bfr_dataframe, academies_y2, academies_y1):
    ...
    bfr_pupil_numbers = pd.merge(
        ...
        academies_y2[['Trust UPIN','Number of pupils']].rename(columns={
            ...
            }).groupby('TrustUPIN').agg(np.nansum), how='left', on='TrustUPIN')
    ...
    bfr_revenue_reserves_per_pupil = bfr_revenue_reserves[['TrustUPIN','CreatedBy','Category','Title','EFALineNo']].copy()
