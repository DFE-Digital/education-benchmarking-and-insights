academies_output = [
    ...
    "Educational supplies_Learning resources (non ICT equipment)",
    "LastChangedDate",
    "LSOA (code)",
    "LA Name",
    ...
    "Other costs_Direct revenue financing (revenue contributions to capital)",
    "Direct Grants",
    ...
    "Teaching and Teaching support staff_Agency supply teching staff",
    "Age Average Score",
