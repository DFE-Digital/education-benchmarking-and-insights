...
SELECT CompanyNumber,
       ...
       IIF(TotalExpenditureCS != 0, (TotalExpenditureCS / TotalExpenditure) * 100, NULL) AS 'TotalExpenditureCS',
       IIF(TotalExpenditureCS != 0, (TotalTeachingSupportStaffCostsCS / TotalExpenditure) * 100, NULL) AS 'TotalTeachingSupportStaffCostsCS',
       IIF(TotalExpenditureCS != 0, (TeachingStaffCostsCS / TotalExpenditure) * 100, NULL) AS 'TeachingStaffCostsCS',
       IIF(TotalExpenditureCS != 0, (SupplyTeachingStaffCostsCS / TotalExpenditure) * 100, NULL) AS 'SupplyTeachingStaffCostsCS',
       IIF(TotalExpenditureCS != 0, (EducationalConsultancyCostsCS / TotalExpenditure) * 100, NULL) AS 'EducationalConsultancyCostsCS',
       IIF(TotalExpenditureCS != 0, (EducationSupportStaffCostsCS / TotalExpenditure) * 100, NULL) AS 'EducationSupportStaffCostsCS',
       IIF(TotalExpenditureCS != 0, (AgencySupplyTeachingStaffCostsCS / TotalExpenditure) * 100, NULL) AS 'AgencySupplyTeachingStaffCostsCS',
       IIF(TotalExpenditureCS != 0, (TotalNonEducationalSupportStaffCostsCS / TotalExpenditure) * 100, NULL) AS 'TotalNonEducationalSupportStaffCostsCS',
       IIF(TotalExpenditureCS != 0, (AdministrativeClericalStaffCostsCS / TotalExpenditure) * 100, NULL) AS 'AdministrativeClericalStaffCostsCS',
       IIF(TotalExpenditureCS != 0, (AuditorsCostsCS / TotalExpenditure) * 100, NULL) AS 'AuditorsCostsCS',
       IIF(TotalExpenditureCS != 0, (OtherStaffCostsCS / TotalExpenditure) * 100, NULL) AS 'OtherStaffCostsCS',
       IIF(TotalExpenditureCS != 0, (ProfessionalServicesNonCurriculumCostsCS / TotalExpenditure) * 100, NULL) AS 'ProfessionalServicesNonCurriculumCostsCS',
       IIF(TotalExpenditureCS != 0, (TotalEducationalSuppliesCostsCS / TotalExpenditure) * 100, NULL) AS 'TotalEducationalSuppliesCostsCS',
       IIF(TotalExpenditureCS != 0, (ExaminationFeesCostsCS / TotalExpenditure) * 100, NULL) AS 'ExaminationFeesCostsCS',
       IIF(TotalExpenditureCS != 0, (LearningResourcesNonIctCostsCS / TotalExpenditure) * 100, NULL) AS 'LearningResourcesNonIctCostsCS',
       IIF(TotalExpenditureCS != 0, (LearningResourcesIctCostsCS / TotalExpenditure) * 100, NULL) AS 'LearningResourcesIctCostsCS',
       IIF(TotalExpenditureCS != 0, (TotalGrossCateringCostsCS / TotalExpenditure) * 100, NULL) AS 'TotalGrossCateringCostsCS',
       IIF(TotalExpenditureCS != 0, (TotalNetCateringCostsCS / TotalExpenditure) * 100, NULL) AS 'TotalNetCateringCostsCS',
       IIF(TotalExpenditureCS != 0, (CateringStaffCostsCS / TotalExpenditure) * 100, NULL) AS 'CateringStaffCostsCS',
       IIF(TotalExpenditureCS != 0, (CateringSuppliesCostsCS / TotalExpenditure) * 100, NULL) AS 'CateringSuppliesCostsCS',
       IIF(TotalExpenditureCS != 0, (TotalOtherCostsCS / TotalExpenditure) * 100, NULL) AS 'TotalOtherCostsCS',
       IIF(TotalExpenditureCS != 0, (GroundsMaintenanceCostsCS / TotalExpenditure) * 100, NULL) AS 'GroundsMaintenanceCostsCS',
       IIF(TotalExpenditureCS != 0, (IndirectEmployeeExpensesCS / TotalExpenditure) * 100, NULL) AS 'IndirectEmployeeExpensesCS',
       IIF(TotalExpenditureCS != 0, (InterestChargesLoanBankCS / TotalExpenditure) * 100, NULL) AS 'InterestChargesLoanBankCS',
       IIF(TotalExpenditureCS != 0, (OtherInsurancePremiumsCostsCS / TotalExpenditure) * 100, NULL) AS 'OtherInsurancePremiumsCostsCS',
       IIF(TotalExpenditureCS != 0, (PrivateFinanceInitiativeChargesCS / TotalExpenditure) * 100, NULL) AS 'PrivateFinanceInitiativeChargesCS',
       IIF(TotalExpenditureCS != 0, (RentRatesCostsCS / TotalExpenditure) * 100, NULL) AS 'RentRatesCostsCS',
       IIF(TotalExpenditureCS != 0, (SpecialFacilitiesCostsCS / TotalExpenditure) * 100, NULL) AS 'SpecialFacilitiesCostsCS',
       IIF(TotalExpenditureCS != 0, (StaffDevelopmentTrainingCostsCS / TotalExpenditure) * 100, NULL) AS 'StaffDevelopmentTrainingCostsCS',
       IIF(TotalExpenditureCS != 0, (StaffRelatedInsuranceCostsCS / TotalExpenditure) * 100, NULL) AS 'StaffRelatedInsuranceCostsCS',
       IIF(TotalExpenditureCS != 0, (SupplyTeacherInsurableCostsCS / TotalExpenditure) * 100, NULL) AS 'SupplyTeacherInsurableCostsCS',
       IIF(TotalExpenditureCS != 0, (AdministrativeSuppliesNonEducationalCostsCS / TotalExpenditure) * 100, NULL) AS 'AdministrativeSuppliesNonEducationalCostsCS',
       IIF(TotalExpenditureCS != 0, (TotalPremisesStaffServiceCostsCS / TotalExpenditure) * 100, NULL) AS 'TotalPremisesStaffServiceCostsCS',
       IIF(TotalExpenditureCS != 0, (CleaningCaretakingCostsCS / TotalExpenditure) * 100, NULL) AS 'CleaningCaretakingCostsCS',
       IIF(TotalExpenditureCS != 0, (MaintenancePremisesCostsCS / TotalExpenditure) * 100, NULL) AS 'MaintenancePremisesCostsCS',
       IIF(TotalExpenditureCS != 0, (OtherOccupationCostsCS / TotalExpenditure) * 100, NULL) AS 'OtherOccupationCostsCS',
       IIF(TotalExpenditureCS != 0, (PremisesStaffCostsCS / TotalExpenditure) * 100, NULL) AS 'PremisesStaffCostsCS',
       IIF(TotalExpenditureCS != 0, (TotalUtilitiesCostsCS / TotalExpenditure) * 100, NULL) AS 'TotalUtilitiesCostsCS',
       IIF(TotalExpenditureCS != 0, (EnergyCostsCS / TotalExpenditure) * 100, NULL) AS 'EnergyCostsCS',
       IIF(TotalExpenditureCS != 0, (WaterSewerageCostsCS / TotalExpenditure) * 100, NULL) AS 'WaterSewerageCostsCS',
       IIF(TotalExpenditureSchool != 0, (TotalExpenditureSchool / TotalExpenditure) * 100, NULL) AS 'TotalExpenditureSchool',
       IIF(TotalExpenditureSchool != 0, (TotalTeachingSupportStaffCostsSchool / TotalExpenditure) * 100, NULL) AS 'TotalTeachingSupportStaffCostsSchool',
       IIF(TotalExpenditureSchool != 0, (TeachingStaffCostsSchool / TotalExpenditure) * 100, NULL) AS 'TeachingStaffCostsSchool',
       IIF(TotalExpenditureSchool != 0, (SupplyTeachingStaffCostsSchool / TotalExpenditure) * 100, NULL) AS 'SupplyTeachingStaffCostsSchool',
       IIF(TotalExpenditureSchool != 0, (EducationalConsultancyCostsSchool / TotalExpenditure) * 100, NULL) AS 'EducationalConsultancyCostsSchool',
       IIF(TotalExpenditureSchool != 0, (EducationSupportStaffCostsSchool / TotalExpenditure) * 100, NULL) AS 'EducationSupportStaffCostsSchool',
       IIF(TotalExpenditureSchool != 0, (AgencySupplyTeachingStaffCostsSchool / TotalExpenditure) * 100, NULL) AS 'AgencySupplyTeachingStaffCostsSchool',
       IIF(TotalExpenditureSchool != 0, (TotalNonEducationalSupportStaffCostsSchool / TotalExpenditure) * 100, NULL) AS 'TotalNonEducationalSupportStaffCostsSchool',
       IIF(TotalExpenditureSchool != 0, (AdministrativeClericalStaffCostsSchool / TotalExpenditure) * 100, NULL) AS 'AdministrativeClericalStaffCostsSchool',
       IIF(TotalExpenditureSchool != 0, (AuditorsCostsSchool / TotalExpenditure) * 100, NULL) AS 'AuditorsCostsSchool',
       IIF(TotalExpenditureSchool != 0, (OtherStaffCostsSchool / TotalExpenditure) * 100, NULL) AS 'OtherStaffCostsSchool',
       IIF(TotalExpenditureSchool != 0, (ProfessionalServicesNonCurriculumCostsSchool / TotalExpenditure) * 100, NULL) AS 'ProfessionalServicesNonCurriculumCostsSchool',
       IIF(TotalExpenditureSchool != 0, (TotalEducationalSuppliesCostsSchool / TotalExpenditure) * 100, NULL) AS 'TotalEducationalSuppliesCostsSchool',
       IIF(TotalExpenditureSchool != 0, (ExaminationFeesCostsSchool / TotalExpenditure) * 100, NULL) AS 'ExaminationFeesCostsSchool',
       IIF(TotalExpenditureSchool != 0, (LearningResourcesNonIctCostsSchool / TotalExpenditure) * 100, NULL) AS 'LearningResourcesNonIctCostsSchool',
       IIF(TotalExpenditureSchool != 0, (LearningResourcesIctCostsSchool / TotalExpenditure) * 100, NULL) AS 'LearningResourcesIctCostsSchool',
       IIF(TotalExpenditureSchool != 0, (TotalGrossCateringCostsSchool / TotalExpenditure) * 100, NULL) AS 'TotalGrossCateringCostsSchool',
       IIF(TotalExpenditureSchool != 0, (TotalNetCateringCostsSchool / TotalExpenditure) * 100, NULL) AS 'TotalNetCateringCostsSchool',
       IIF(TotalExpenditureSchool != 0, (CateringStaffCostsSchool / TotalExpenditure) * 100, NULL) AS 'CateringStaffCostsSchool',
       IIF(TotalExpenditureSchool != 0, (CateringSuppliesCostsSchool / TotalExpenditure) * 100, NULL) AS 'CateringSuppliesCostsSchool',
       IIF(TotalExpenditureSchool != 0, (TotalOtherCostsSchool / TotalExpenditure) * 100, NULL) AS 'TotalOtherCostsSchool',
       IIF(TotalExpenditureSchool != 0, (GroundsMaintenanceCostsSchool / TotalExpenditure) * 100, NULL) AS 'GroundsMaintenanceCostsSchool',
       IIF(TotalExpenditureSchool != 0, (IndirectEmployeeExpensesSchool / TotalExpenditure) * 100, NULL) AS 'IndirectEmployeeExpensesSchool',
       IIF(TotalExpenditureSchool != 0, (InterestChargesLoanBankSchool / TotalExpenditure) * 100, NULL) AS 'InterestChargesLoanBankSchool',
       IIF(TotalExpenditureSchool != 0, (OtherInsurancePremiumsCostsSchool / TotalExpenditure) * 100, NULL) AS 'OtherInsurancePremiumsCostsSchool',
       IIF(TotalExpenditureSchool != 0, (PrivateFinanceInitiativeChargesSchool / TotalExpenditure) * 100, NULL) AS 'PrivateFinanceInitiativeChargesSchool',
       IIF(TotalExpenditureSchool != 0, (RentRatesCostsSchool / TotalExpenditure) * 100, NULL) AS 'RentRatesCostsSchool',
       IIF(TotalExpenditureSchool != 0, (SpecialFacilitiesCostsSchool / TotalExpenditure) * 100, NULL) AS 'SpecialFacilitiesCostsSchool',
       IIF(TotalExpenditureSchool != 0, (StaffDevelopmentTrainingCostsSchool / TotalExpenditure) * 100, NULL) AS 'StaffDevelopmentTrainingCostsSchool',
       IIF(TotalExpenditureSchool != 0, (StaffRelatedInsuranceCostsSchool / TotalExpenditure) * 100, NULL) AS 'StaffRelatedInsuranceCostsSchool',
       IIF(TotalExpenditureSchool != 0, (SupplyTeacherInsurableCostsSchool / TotalExpenditure) * 100, NULL) AS 'SupplyTeacherInsurableCostsSchool',
       IIF(TotalExpenditureSchool != 0, (AdministrativeSuppliesNonEducationalCostsSchool / TotalExpenditure) * 100, NULL) AS 'AdministrativeSuppliesNonEducationalCostsSchool',
       IIF(TotalExpenditureSchool != 0, (TotalPremisesStaffServiceCostsSchool / TotalExpenditure) * 100, NULL) AS 'TotalPremisesStaffServiceCostsSchool',
       IIF(TotalExpenditureSchool != 0, (CleaningCaretakingCostsSchool / TotalExpenditure) * 100, NULL) AS 'CleaningCaretakingCostsSchool',
       IIF(TotalExpenditureSchool != 0, (MaintenancePremisesCostsSchool / TotalExpenditure) * 100, NULL) AS 'MaintenancePremisesCostsSchool',
       IIF(TotalExpenditureSchool != 0, (OtherOccupationCostsSchool / TotalExpenditure) * 100, NULL) AS 'OtherOccupationCostsSchool',
       IIF(TotalExpenditureSchool != 0, (PremisesStaffCostsSchool / TotalExpenditure) * 100, NULL) AS 'PremisesStaffCostsSchool',
       IIF(TotalExpenditureSchool != 0, (TotalUtilitiesCostsSchool / TotalExpenditure) * 100, NULL) AS 'TotalUtilitiesCostsSchool',
       IIF(TotalExpenditureSchool != 0, (EnergyCostsSchool / TotalExpenditure) * 100, NULL) AS 'EnergyCostsSchool',
       IIF(TotalExpenditureSchool != 0, (WaterSewerageCostsSchool / TotalExpenditure) * 100, NULL) AS 'WaterSewerageCostsSchool',
       EMLBand,
       TotalPupils
FROM VW_TrustFinancialDefault
GO
...
SELECT CompanyNumber,
       ...
       IIF(TotalIncomeCS != 0, (TotalExpenditureCS / TotalIncome) * 100, NULL) AS 'TotalExpenditureCS',
       IIF(TotalIncomeCS != 0, (TotalTeachingSupportStaffCostsCS / TotalIncome) * 100, NULL) AS 'TotalTeachingSupportStaffCostsCS',
       IIF(TotalIncomeCS != 0, (TeachingStaffCostsCS / TotalIncome) * 100, NULL) AS 'TeachingStaffCostsCS',
       IIF(TotalIncomeCS != 0, (SupplyTeachingStaffCostsCS / TotalIncome) * 100, NULL) AS 'SupplyTeachingStaffCostsCS',
       IIF(TotalIncomeCS != 0, (EducationalConsultancyCostsCS / TotalIncome) * 100, NULL) AS 'EducationalConsultancyCostsCS',
       IIF(TotalIncomeCS != 0, (EducationSupportStaffCostsCS / TotalIncome) * 100, NULL) AS 'EducationSupportStaffCostsCS',
       IIF(TotalIncomeCS != 0, (AgencySupplyTeachingStaffCostsCS / TotalIncome) * 100, NULL) AS 'AgencySupplyTeachingStaffCostsCS',
       IIF(TotalIncomeCS != 0, (TotalNonEducationalSupportStaffCostsCS / TotalIncome) * 100, NULL) AS 'TotalNonEducationalSupportStaffCostsCS',
       IIF(TotalIncomeCS != 0, (AdministrativeClericalStaffCostsCS / TotalIncome) * 100, NULL) AS 'AdministrativeClericalStaffCostsCS',
       IIF(TotalIncomeCS != 0, (AuditorsCostsCS / TotalIncome) * 100, NULL) AS 'AuditorsCostsCS',
       IIF(TotalIncomeCS != 0, (OtherStaffCostsCS / TotalIncome) * 100, NULL) AS 'OtherStaffCostsCS',
       IIF(TotalIncomeCS != 0, (ProfessionalServicesNonCurriculumCostsCS / TotalIncome) * 100, NULL) AS 'ProfessionalServicesNonCurriculumCostsCS',
       IIF(TotalIncomeCS != 0, (TotalEducationalSuppliesCostsCS / TotalIncome) * 100, NULL) AS 'TotalEducationalSuppliesCostsCS',
       IIF(TotalIncomeCS != 0, (ExaminationFeesCostsCS / TotalIncome) * 100, NULL) AS 'ExaminationFeesCostsCS',
       IIF(TotalIncomeCS != 0, (LearningResourcesNonIctCostsCS / TotalIncome) * 100, NULL) AS 'LearningResourcesNonIctCostsCS',
       IIF(TotalIncomeCS != 0, (LearningResourcesIctCostsCS / TotalIncome) * 100, NULL) AS 'LearningResourcesIctCostsCS',
       IIF(TotalIncomeCS != 0, (TotalGrossCateringCostsCS / TotalIncome) * 100, NULL) AS 'TotalGrossCateringCostsCS',
       IIF(TotalIncomeCS != 0, (TotalNetCateringCostsCS / TotalIncome) * 100, NULL) AS 'TotalNetCateringCostsCS',
       IIF(TotalIncomeCS != 0, (CateringStaffCostsCS / TotalIncome) * 100, NULL) AS 'CateringStaffCostsCS',
       IIF(TotalIncomeCS != 0, (CateringSuppliesCostsCS / TotalIncome) * 100, NULL) AS 'CateringSuppliesCostsCS',
       IIF(TotalIncomeCS != 0, (TotalOtherCostsCS / TotalIncome) * 100, NULL) AS 'TotalOtherCostsCS',
       IIF(TotalIncomeCS != 0, (GroundsMaintenanceCostsCS / TotalIncome) * 100, NULL) AS 'GroundsMaintenanceCostsCS',
       IIF(TotalIncomeCS != 0, (IndirectEmployeeExpensesCS / TotalIncome) * 100, NULL) AS 'IndirectEmployeeExpensesCS',
       IIF(TotalIncomeCS != 0, (InterestChargesLoanBankCS / TotalIncome) * 100, NULL) AS 'InterestChargesLoanBankCS',
       IIF(TotalIncomeCS != 0, (OtherInsurancePremiumsCostsCS / TotalIncome) * 100, NULL) AS 'OtherInsurancePremiumsCostsCS',
       IIF(TotalIncomeCS != 0, (PrivateFinanceInitiativeChargesCS / TotalIncome) * 100, NULL) AS 'PrivateFinanceInitiativeChargesCS',
       IIF(TotalIncomeCS != 0, (RentRatesCostsCS / TotalIncome) * 100, NULL) AS 'RentRatesCostsCS',
       IIF(TotalIncomeCS != 0, (SpecialFacilitiesCostsCS / TotalIncome) * 100, NULL) AS 'SpecialFacilitiesCostsCS',
       IIF(TotalIncomeCS != 0, (StaffDevelopmentTrainingCostsCS / TotalIncome) * 100, NULL) AS 'StaffDevelopmentTrainingCostsCS',
       IIF(TotalIncomeCS != 0, (StaffRelatedInsuranceCostsCS / TotalIncome) * 100, NULL) AS 'StaffRelatedInsuranceCostsCS',
       IIF(TotalIncomeCS != 0, (SupplyTeacherInsurableCostsCS / TotalIncome) * 100, NULL) AS 'SupplyTeacherInsurableCostsCS',
       IIF(TotalIncomeCS != 0, (AdministrativeSuppliesNonEducationalCostsCS / TotalIncome) * 100, NULL) AS 'AdministrativeSuppliesNonEducationalCostsCS',
       IIF(TotalIncomeCS != 0, (TotalPremisesStaffServiceCostsCS / TotalIncome) * 100, NULL) AS 'TotalPremisesStaffServiceCostsCS',
       IIF(TotalIncomeCS != 0, (CleaningCaretakingCostsCS / TotalIncome) * 100, NULL) AS 'CleaningCaretakingCostsCS',
       IIF(TotalIncomeCS != 0, (MaintenancePremisesCostsCS / TotalIncome) * 100, NULL) AS 'MaintenancePremisesCostsCS',
       IIF(TotalIncomeCS != 0, (OtherOccupationCostsCS / TotalIncome) * 100, NULL) AS 'OtherOccupationCostsCS',
       IIF(TotalIncomeCS != 0, (PremisesStaffCostsCS / TotalIncome) * 100, NULL) AS 'PremisesStaffCostsCS',
       IIF(TotalIncomeCS != 0, (TotalUtilitiesCostsCS / TotalIncome) * 100, NULL) AS 'TotalUtilitiesCostsCS',
       IIF(TotalIncomeCS != 0, (EnergyCostsCS / TotalIncome) * 100, NULL) AS 'EnergyCostsCS',
       IIF(TotalIncomeCS != 0, (WaterSewerageCostsCS / TotalIncome) * 100, NULL) AS 'WaterSewerageCostsCS',
       IIF(TotalIncomeSchool != 0, (TotalExpenditureSchool / TotalIncome) * 100, NULL) AS 'TotalExpenditureSchool',
       IIF(TotalIncomeSchool != 0, (TotalTeachingSupportStaffCostsSchool / TotalIncome) * 100, NULL) AS 'TotalTeachingSupportStaffCostsSchool',
       IIF(TotalIncomeSchool != 0, (TeachingStaffCostsSchool / TotalIncome) * 100, NULL) AS 'TeachingStaffCostsSchool',
       IIF(TotalIncomeSchool != 0, (SupplyTeachingStaffCostsSchool / TotalIncome) * 100, NULL) AS 'SupplyTeachingStaffCostsSchool',
       IIF(TotalIncomeSchool != 0, (EducationalConsultancyCostsSchool / TotalIncome) * 100, NULL) AS 'EducationalConsultancyCostsSchool',
       IIF(TotalIncomeSchool != 0, (EducationSupportStaffCostsSchool / TotalIncome) * 100, NULL) AS 'EducationSupportStaffCostsSchool',
       IIF(TotalIncomeSchool != 0, (AgencySupplyTeachingStaffCostsSchool / TotalIncome) * 100, NULL) AS 'AgencySupplyTeachingStaffCostsSchool',
       IIF(TotalIncomeSchool != 0, (TotalNonEducationalSupportStaffCostsSchool / TotalIncome) * 100, NULL) AS 'TotalNonEducationalSupportStaffCostsSchool',
       IIF(TotalIncomeSchool != 0, (AdministrativeClericalStaffCostsSchool / TotalIncome) * 100, NULL) AS 'AdministrativeClericalStaffCostsSchool',
       IIF(TotalIncomeSchool != 0, (AuditorsCostsSchool / TotalIncome) * 100, NULL) AS 'AuditorsCostsSchool',
       IIF(TotalIncomeSchool != 0, (OtherStaffCostsSchool / TotalIncome) * 100, NULL) AS 'OtherStaffCostsSchool',
       IIF(TotalIncomeSchool != 0, (ProfessionalServicesNonCurriculumCostsSchool / TotalIncome) * 100, NULL) AS 'ProfessionalServicesNonCurriculumCostsSchool',
       IIF(TotalIncomeSchool != 0, (TotalEducationalSuppliesCostsSchool / TotalIncome) * 100, NULL) AS 'TotalEducationalSuppliesCostsSchool',
       IIF(TotalIncomeSchool != 0, (ExaminationFeesCostsSchool / TotalIncome) * 100, NULL) AS 'ExaminationFeesCostsSchool',
       IIF(TotalIncomeSchool != 0, (LearningResourcesNonIctCostsSchool / TotalIncome) * 100, NULL) AS 'LearningResourcesNonIctCostsSchool',
       IIF(TotalIncomeSchool != 0, (LearningResourcesIctCostsSchool / TotalIncome) * 100, NULL) AS 'LearningResourcesIctCostsSchool',
       IIF(TotalIncomeSchool != 0, (TotalGrossCateringCostsSchool / TotalIncome) * 100, NULL) AS 'TotalGrossCateringCostsSchool',
       IIF(TotalIncomeSchool != 0, (TotalNetCateringCostsSchool / TotalIncome) * 100, NULL) AS 'TotalNetCateringCostsSchool',
       IIF(TotalIncomeSchool != 0, (CateringStaffCostsSchool / TotalIncome) * 100, NULL) AS 'CateringStaffCostsSchool',
       IIF(TotalIncomeSchool != 0, (CateringSuppliesCostsSchool / TotalIncome) * 100, NULL) AS 'CateringSuppliesCostsSchool',
       IIF(TotalIncomeSchool != 0, (TotalOtherCostsSchool / TotalIncome) * 100, NULL) AS 'TotalOtherCostsSchool',
       IIF(TotalIncomeSchool != 0, (GroundsMaintenanceCostsSchool / TotalIncome) * 100, NULL) AS 'GroundsMaintenanceCostsSchool',
       IIF(TotalIncomeSchool != 0, (IndirectEmployeeExpensesSchool / TotalIncome) * 100, NULL) AS 'IndirectEmployeeExpensesSchool',
       IIF(TotalIncomeSchool != 0, (InterestChargesLoanBankSchool / TotalIncome) * 100, NULL) AS 'InterestChargesLoanBankSchool',
       IIF(TotalIncomeSchool != 0, (OtherInsurancePremiumsCostsSchool / TotalIncome) * 100, NULL) AS 'OtherInsurancePremiumsCostsSchool',
       IIF(TotalIncomeSchool != 0, (PrivateFinanceInitiativeChargesSchool / TotalIncome) * 100, NULL) AS 'PrivateFinanceInitiativeChargesSchool',
       IIF(TotalIncomeSchool != 0, (RentRatesCostsSchool / TotalIncome) * 100, NULL) AS 'RentRatesCostsSchool',
       IIF(TotalIncomeSchool != 0, (SpecialFacilitiesCostsSchool / TotalIncome) * 100, NULL) AS 'SpecialFacilitiesCostsSchool',
       IIF(TotalIncomeSchool != 0, (StaffDevelopmentTrainingCostsSchool / TotalIncome) * 100, NULL) AS 'StaffDevelopmentTrainingCostsSchool',
       IIF(TotalIncomeSchool != 0, (StaffRelatedInsuranceCostsSchool / TotalIncome) * 100, NULL) AS 'StaffRelatedInsuranceCostsSchool',
       IIF(TotalIncomeSchool != 0, (SupplyTeacherInsurableCostsSchool / TotalIncome) * 100, NULL) AS 'SupplyTeacherInsurableCostsSchool',
       IIF(TotalIncomeSchool != 0, (AdministrativeSuppliesNonEducationalCostsSchool / TotalIncome) * 100, NULL) AS 'AdministrativeSuppliesNonEducationalCostsSchool',
       IIF(TotalIncomeSchool != 0, (TotalPremisesStaffServiceCostsSchool / TotalIncome) * 100, NULL) AS 'TotalPremisesStaffServiceCostsSchool',
       IIF(TotalIncomeSchool != 0, (CleaningCaretakingCostsSchool / TotalIncome) * 100, NULL) AS 'CleaningCaretakingCostsSchool',
       IIF(TotalIncomeSchool != 0, (MaintenancePremisesCostsSchool / TotalIncome) * 100, NULL) AS 'MaintenancePremisesCostsSchool',
       IIF(TotalIncomeSchool != 0, (OtherOccupationCostsSchool / TotalIncome) * 100, NULL) AS 'OtherOccupationCostsSchool',
       IIF(TotalIncomeSchool != 0, (PremisesStaffCostsSchool / TotalIncome) * 100, NULL) AS 'PremisesStaffCostsSchool',
       IIF(TotalIncomeSchool != 0, (TotalUtilitiesCostsSchool / TotalIncome) * 100, NULL) AS 'TotalUtilitiesCostsSchool',
       IIF(TotalIncomeSchool != 0, (EnergyCostsSchool / TotalIncome) * 100, NULL) AS 'EnergyCostsSchool',
       IIF(TotalIncomeSchool != 0, (WaterSewerageCostsSchool / TotalIncome) * 100, NULL) AS 'WaterSewerageCostsSchool',
       EMLBand,
       TotalPupils
FROM VW_TrustFinancialDefault
GO
