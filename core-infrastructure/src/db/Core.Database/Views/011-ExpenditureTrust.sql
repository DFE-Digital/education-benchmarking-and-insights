...
SELECT CompanyNumber,
       ...
       DirectRevenueFinancingCostsSchool,
...
SELECT CompanyNumber,
       ...
       IIF(TotalExpenditure != 0, (DirectRevenueFinancingCosts / TotalExpenditure) * 100, NULL) AS 'DirectRevenueFinancingCosts',
       ...
       IIF(TotalExpenditureCS != 0, (DirectRevenueFinancingCostsCS / TotalExpenditureCS) * 100, NULL) AS 'DirectRevenueFinancingCostsCS',
       ...
       IIF(TotalExpenditureSchool != 0, (DirectRevenueFinancingCostsSchool / TotalExpenditureSchool) * 100, NULL) AS 'DirectRevenueFinancingCostsSchool',
...
SELECT CompanyNumber,
       ...
       IIF(TotalIncome != 0, (DirectRevenueFinancingCosts / TotalIncome) * 100, NULL) AS 'DirectRevenueFinancingCosts',
       ...
       IIF(TotalIncomeCS != 0, (DirectRevenueFinancingCostsCS / TotalIncomeCS) * 100, NULL) AS 'DirectRevenueFinancingCostsCS',
       ...
       IIF(TotalIncomeSchool != 0, (DirectRevenueFinancingCostsSchool / TotalIncomeSchool) * 100, NULL) AS 'DirectRevenueFinancingCostsSchool',
...
SELECT CompanyNumber,
       ...
       IIF(TotalPupils != 0, DirectRevenueFinancingCosts / TotalPupils, NULL) AS 'DirectRevenueFinancingCosts',
       ...
       IIF(TotalPupils != 0, DirectRevenueFinancingCostsCS / TotalPupils, NULL) AS 'DirectRevenueFinancingCostsCS',
       ...
       IIF(TotalPupils != 0, DirectRevenueFinancingCostsSchool / TotalPupils, NULL) AS 'DirectRevenueFinancingCostsSchool',
