...
SELECT RunId,
       ...
       FinanceType,
       TotalPupils,
       IIF(WorkforceFTE > 0.0, WorkforceHeadcount /  WorkforceFTE, NULL) AS 'Workforce',
       IIF(WorkforceHeadcount > 0.0, WorkforceHeadcount /  WorkforceHeadcount, NULL) AS 'WorkforceHeadcount',
       IIF(TeachersFTE > 0.0, TeachersHeadcount /  TeachersFTE, NULL) AS 'Teachers',
       IIF(SeniorLeadershipFTE > 0.0, SeniorLeadershipHeadcount /  SeniorLeadershipFTE, NULL) AS 'SeniorLeadership',
       IIF(TeachingAssistantFTE > 0.0, TeachingAssistantHeadcount /  TeachingAssistantFTE, NULL) AS 'TeachingAssistant',
       IIF(NonClassroomSupportStaffFTE > 0.0, NonClassroomSupportStaffHeadcount /  NonClassroomSupportStaffFTE, NULL) AS 'NonClassroomSupportStaff',
       IIF(AuxiliaryStaffFTE > 0.0, AuxiliaryStaffHeadcount /  AuxiliaryStaffFTE, NULL) AS 'AuxiliaryStaff',
       PercentTeacherWithQualifiedStatus
FROM NonFinancial
GO
...
SELECT RunId,
       ...
       FinanceType,
       TotalPupils,
       IIF(WorkforceFTE > 0.0, (WorkforceFTE /  WorkforceFTE) * 100, NULL) AS 'Workforce',
       IIF(WorkforceHeadcount > 0.0, (WorkforceHeadcount /  WorkforceHeadcount) * 100, NULL) AS 'WorkforceHeadcount',
       IIF(WorkforceFTE > 0.0, (TeachersFTE /  WorkforceFTE) * 100, NULL) AS 'Teachers',
       IIF(WorkforceFTE > 0.0, (SeniorLeadershipFTE /  WorkforceFTE) * 100, NULL) AS 'SeniorLeadership',
       IIF(WorkforceFTE > 0.0, (TeachingAssistantFTE /  WorkforceFTE) * 100, NULL) AS 'TeachingAssistant',
       IIF(WorkforceFTE > 0.0, (NonClassroomSupportStaffFTE /  WorkforceFTE) * 100, NULL) AS 'NonClassroomSupportStaff',
       IIF(WorkforceFTE > 0.0, (AuxiliaryStaffFTE /  WorkforceFTE) * 100, NULL) AS 'AuxiliaryStaff',
       PercentTeacherWithQualifiedStatus
FROM NonFinancial
GO
...
SELECT RunId,
       ...
       FinanceType,
       TotalPupils,
       IIF(WorkforceFTE > 0.0, TotalPupils /  WorkforceFTE, NULL) AS 'Workforce',
       IIF(WorkforceHeadcount > 0.0, TotalPupils /  WorkforceHeadcount, NULL) AS 'WorkforceHeadcount',
       IIF(TeachersFTE > 0.0, TotalPupils /  TeachersFTE, NULL) AS 'Teachers',
       IIF(SeniorLeadershipFTE > 0.0, TotalPupils /  SeniorLeadershipFTE, NULL) AS 'SeniorLeadership',
       IIF(TeachingAssistantFTE > 0.0, TotalPupils /  TeachingAssistantFTE, NULL) AS 'TeachingAssistant',
       IIF(NonClassroomSupportStaffFTE > 0.0, TotalPupils /  NonClassroomSupportStaffFTE, NULL) AS 'NonClassroomSupportStaff',
       IIF(AuxiliaryStaffFTE > 0.0, TotalPupils /  AuxiliaryStaffFTE, NULL) AS 'AuxiliaryStaff',
       PercentTeacherWithQualifiedStatus
FROM NonFinancial
GO
