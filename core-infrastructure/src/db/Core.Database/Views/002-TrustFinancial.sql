...
SELECT RunId,
       ...
       TotalIncome - ISNULL(TotalExpenditureCS, 0)      AS 'TotalIncomeSchool',
       InYearBalance,
       ...
       ISNULL(DirectRevenueFinancingCostsCS, 0) AS 'DirectRevenueFinancingCostsCS',
       ...
       LearningResourcesIctCosts - ISNULL(LearningResourcesIctCosts, 0) AS 'LearningResourcesIctCostsSchool',
       ...
       DirectRevenueFinancingCosts - ISNULL(DirectRevenueFinancingCostsCS, 0) AS 'DirectRevenueFinancingCostsSchool',
