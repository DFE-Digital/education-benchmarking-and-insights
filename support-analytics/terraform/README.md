...
| [azurerm_log_analytics_query_pack_query.tracked-auth](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/log_analytics_query_pack_query) | resource |
...
| [azurerm_log_analytics_saved_search.get-sfb-referrer-requests](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/log_analytics_saved_search) | resource |
| [azurerm_log_analytics_saved_search.get-tracked-auth](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/log_analytics_saved_search) | resource |
...
| [azurerm_monitor_metric_alert.chart_rendering_api_error_alert](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/monitor_metric_alert) | resource |
| [azurerm_monitor_metric_alert.chart_rendering_asp_cpu_alert](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/monitor_metric_alert) | resource |
| [azurerm_monitor_metric_alert.chart_rendering_asp_memory_alert](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/monitor_metric_alert) | resource |
| [azurerm_monitor_metric_alert.content_api_error_alert](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/monitor_metric_alert) | resource |
...
| [azurerm_monitor_metric_alert.local_authority_finances_api_error_alert](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/monitor_metric_alert) | resource |
...
| [random_uuid.tracked-auth-id](https://registry.terraform.io/providers/hashicorp/random/latest/docs/resources/uuid) | resource |
...
| [azurerm_linux_function_app.chart-rendering-api](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/linux_function_app) | data source |
...
| [azurerm_service_plan.chart-rendering-asp](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/service_plan) | data source |
...
| [azurerm_windows_function_app.content-api](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/windows_function_app) | data source |
...
| [azurerm_windows_function_app.local-authority-finances-api](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/windows_function_app) | data source |
| [azurerm_windows_function_app.non-financial-api](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/windows_function_app) | data source |
...
| <a name="input_trackedEvents"></a> [trackedEvents](#input\_trackedEvents) | n/a | `list(string)` | <pre>[<br/>  "change-organisation",<br/>  "commercial-resource",<br/>  "copy-chart-as-image",<br/>  "data-source",<br/>  "download-page-data",<br/>  "gias-school-details",<br/>  "guidance-resource",<br/>  "la-school-homepage",<br/>  "organisation",<br/>  "save-chart-as-image",<br/>  "service-banner",<br/>  "survey"<br/>]</pre> | no |
