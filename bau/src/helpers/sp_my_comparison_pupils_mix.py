...
class SpMyComparisonPupilsMixHelper():
    ...
    def run_procedure(self):
        print('------------')
        print('Running mixed schools pupil comparator set creation')
        print('------------')
        # filter down data
        ...
        self.all_schools_data.loc[
            ...
            'Boarding'] = 'Not Boarding'
        self.all_schools_data.loc[
            (self.all_schools_data['SchoolPhaseType']=='Pupil referral unit'), 'SchoolPhaseType'
            ] = 'AP-PRU'
        self.all_schools_data.loc[
        ...
        self.all_schools_data['phase_boarding'] = self.all_schools_data[
            ['SchoolPhaseType','Boarding']
            ].apply(lambda row: f"{row['SchoolPhaseType']}-{row['Boarding']}", axis=1)
        ...
        ms_mappings = self.academy_groups_mapping.loc[
            (self.academy_groups_mapping['Sector']=='Mixed') & (self.academy_groups_mapping['CompGroup']=='Pupil')
            ]
