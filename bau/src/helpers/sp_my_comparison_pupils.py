"""
Copied from the sp_my_comparison_pupils (academy pupils) stored procedure as part of the VMFI 
data drop.
"""
...
class SpMyComparisonPupilsAcHelper():
    ...
    def run_procedure(self):
        print('------------')
        print('Running academy schools pupil comparator set creation')
        print('------------')
        # filter down data
        ...
        self.academies_data = self.academies_data.loc[
                                    self.academies_data['DataReleaseId'] == 10]
        ...
        self.all_schools_data = self.academies_data[['UKPRN_URN',
                                                       'Region_added',
                                                       'Percent_SEN_all',
                                                       'NumberOfPupils',
                                                       'PercentageFSM',
        ...
        self.all_schools_data = self.all_schools_data.loc[(self.all_schools_data['UKPRN_URN']!=0) | (self.all_schools_data['UKPRN_URN']!='0')]
        ...
        self.all_schools_data = self.all_schools_data.loc[self.all_schools_data['DataReleaseId']==10]
        ...
        ms_mappings = self.academy_groups_mapping.loc[
            (self.academy_groups_mapping['Sector']=='Academy') & (self.academy_groups_mapping['CompGroup']=='Pupil')
            ]
