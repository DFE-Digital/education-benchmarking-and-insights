...
public class WhenMetricRagRatingsServiceQueriesAsync
{
    ...
    [InlineData(new string[0], new string[0], new string[0], null, "laCode", null, "runType", true, "SELECT * from SchoolMetricRAG WHERE RunType = @RunType AND RunId = @RunId AND LaCode = @LaCode")]
