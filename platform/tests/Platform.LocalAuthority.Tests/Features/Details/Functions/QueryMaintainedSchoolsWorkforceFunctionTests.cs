...
//
// public class QueryMaintainedSchoolsWorkforceFunctionTests : VersionedFunctionTestBase<IQueryMaintainedSchoolWorkforceHandler>
// {
//     private readonly QueryMaintainedSchoolsWorkforceFunction _function;
//     private readonly string _identifier;
//     private readonly MockResponse _response;
//
//     public QueryMaintainedSchoolsWorkforceFunctionTests()
//     {
//         _identifier = Fixture.Create<string>();
//         _response = new MockResponse(_identifier);
//         _function = new QueryMaintainedSchoolsWorkforceFunction(Dispatcher.Object);
//     }
//
//     [Fact]
