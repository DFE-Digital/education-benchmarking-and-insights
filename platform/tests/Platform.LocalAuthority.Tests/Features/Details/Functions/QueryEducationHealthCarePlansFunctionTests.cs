...
//
// public class QueryLocalAuthoritiesFunctionTests : VersionedFunctionTestBase<IQueryLocalAuthoritiesHandler>
// {
//     private readonly QueryLocalAuthoritiesFunction _function;
//     private readonly MockResponse _response;
//
//     public QueryLocalAuthoritiesFunctionTests()
//     {
//         var identifier = Fixture.Create<string>();
//         _response = new MockResponse(identifier);
//         _function = new QueryLocalAuthoritiesFunction(Dispatcher.Object);
//     }
//
//     [Fact]
