...
public class GetLocalAuthorityFunctionTests : VersionedFunctionTestBase<IGetLocalAuthorityHandler>
{
    ...
    public GetLocalAuthorityFunctionTests()
    {
        ...
        _function = new GetLocalAuthorityFunction(Dispatcher.Object);
    }
