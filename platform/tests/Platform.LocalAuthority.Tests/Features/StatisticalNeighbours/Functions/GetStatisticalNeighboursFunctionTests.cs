...
//
// public class GetStatisticalNeighboursFunctionTests : VersionedFunctionTestBase<IGetStatisticalNeighboursHandler>
// {
//     private readonly GetStatisticalNeighboursFunction _function;
//     private readonly string _identifier;
//     private readonly MockResponse _response;
//
//     public GetStatisticalNeighboursFunctionTests()
//     {
//         _identifier = Fixture.Create<string>();
//         _response = new MockResponse(_identifier);
//         _function = new GetStatisticalNeighboursFunction(Dispatcher.Object);
//     }
//
//     [Fact]
