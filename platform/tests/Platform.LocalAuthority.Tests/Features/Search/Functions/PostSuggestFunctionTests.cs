...
//
// public class PostSuggestFunctionTests : VersionedFunctionTestBase<IPostSuggestHandler>
// {
//     private readonly PostSuggestFunction _function;
//     private readonly MockResponse _response;
//
//     public PostSuggestFunctionTests()
//     {
//         var identifier = Fixture.Create<string>();
//         _response = new MockResponse(identifier);
//         _function = new PostSuggestFunction(Dispatcher.Object);
//     }
//
//     [Fact]
