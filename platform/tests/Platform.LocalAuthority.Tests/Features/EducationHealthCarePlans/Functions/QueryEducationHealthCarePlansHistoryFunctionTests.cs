...
//
// public class QueryEducationHealthCarePlansHistoryFunctionTests : VersionedFunctionTestBase<IQueryEducationHealthCarePlansHistoryHandler>
// {
//     private readonly QueryEducationHealthCarePlansHistoryFunction _function;
//     private readonly MockResponse _response;
//
//     public QueryEducationHealthCarePlansHistoryFunctionTests()
//     {
//         var identifier = Fixture.Create<string>();
//         _response = new MockResponse(identifier);
//         _function = new QueryEducationHealthCarePlansHistoryFunction(Dispatcher.Object);
//     }
//
//     [Fact]
