...
//
// public class QueryEducationHealthCarePlansFunctionTests : VersionedFunctionTestBase<IQueryEducationHealthCarePlansHandler>
// {
//     private readonly QueryEducationHealthCarePlansFunction _function;
//     private readonly MockResponse _response;
//
//     public QueryEducationHealthCarePlansFunctionTests()
//     {
//         var identifier = Fixture.Create<string>();
//         _response = new MockResponse(identifier);
//         _function = new QueryEducationHealthCarePlansFunction(Dispatcher.Object);
//     }
//
//     [Fact]
