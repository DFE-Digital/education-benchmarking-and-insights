...
public class WhenIncomeNationalAvgParametersValidatorValidates
{
    private readonly IncomeNationalAvgParametersValidator _validator = new();

    [Fact]
    public async Task ShouldBeValidWithGoodParameters()
    {
        var parameters = new IncomeNationalAvgParameters();
