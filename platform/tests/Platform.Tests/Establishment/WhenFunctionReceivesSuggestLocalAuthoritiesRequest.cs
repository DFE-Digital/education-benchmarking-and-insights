...
public class WhenFunctionReceivesSuggestLocalAuthoritiesRequest : LocalAuthoritiesFunctionsTestBase
{
    ...
    public async Task ShouldReturn200OnValidRequest()
    {
        Search
            ...
            .ReturnsAsync(new SuggestResponseModel<LocalAuthorityResponseModel>());
        ...
        var result =
            await Functions.SuggestLocalAuthoritiesAsync(CreateRequestWithBody(new PostSuggestRequestModel())) as
                JsonContentResult;
    ...
    public async Task ShouldReturn400OnInvalidRequest()
    {
        ...
        Validator
            ...
            .ReturnsAsync(new ValidationResult(new[]
                { new ValidationFailure(nameof(PostSuggestRequestModel.SuggesterName), "This error message") }));
