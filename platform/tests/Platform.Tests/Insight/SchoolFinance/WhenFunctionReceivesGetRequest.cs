...
public class WhenFunctionReceivesGetRequest : SchoolFinanceFunctionsTestBase
{
    ...
    public async Task ShouldReturn200OnValidRequest()
    {
        ...
        var result = await Functions.SchoolSingleAsync(CreateRequest(), "1") as JsonContentResult;
    ...
    public async Task ShouldReturn404OnInvalidRequest()
    {
        ...
        var result = await Functions.SchoolSingleAsync(CreateRequest(), "1") as NotFoundResult;
    ...
    public async Task ShouldReturn500OnError()
    {
        ...
        var result = await Functions.SchoolSingleAsync(CreateRequest(), "1") as StatusCodeResult;
