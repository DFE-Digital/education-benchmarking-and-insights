...
public class WhenFunctionReceivesGetMaintainedSchoolWorkforceHistoryRequest : MaintainedSchoolFunctionsTestBase
{
    [Fact]
    ...
    public async Task ShouldReturn500OnError()
    {
        ...
        var result = await Functions.WorkforceHistoryMaintainedSchoolAsync(CreateRequest(), "1") as StatusCodeResult;
