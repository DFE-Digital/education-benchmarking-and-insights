...
public class WhenExpenditureResponseFactoryCreatesResponseFromSchoolExpenditureHistory
{
    private readonly SchoolExpenditureHistoryModel _model;

    public WhenExpenditureResponseFactoryCreatesResponseFromSchoolExpenditureHistory()
    {
        _model = TestDataReader.ReadTestDataFromFile<SchoolExpenditureHistoryModel>("ExpenditureTestData.json", GetType());
    }
    ...
    [Theory]
    [ClassData(typeof(EducationalSuppliesTestData<SchoolExpenditureHistoryResponse>))]
