...
public class GetForecastRiskFunctionTests : FunctionRunAsyncReflectionTestsBase<GetForecastRiskFunction, IGetForecastRiskMHandler, IdContext>
{
    protected override GetForecastRiskFunction CreateFunction(IEnumerable<IGetForecastRiskMHandler> handlers) => new(handlers);
