...
public class SchoolFinanceFunctions
{
    ...
    public async Task<IActionResult> SchoolIncomeAsync(
        [HttpTrigger(AuthorizationLevel.Admin, "get", Route = "school/{urn}/income")]
        HttpRequest req,
        string urn)
    {
        var correlationId = req.GetCorrelationId();
               ...
               }))
        {
            try
            {
                ...
                var finances = await _db.GetIncome(urn, dimension);
                return finances == null
                    ? new NotFoundResult()
                    : new JsonContentResult(finances);
            }
    ...
    public async Task<IActionResult> SchoolExpenditureAsync(
        [HttpTrigger(AuthorizationLevel.Admin, "get", Route = "school/{urn}/expenditure")]
        HttpRequest req,
        string urn)
    {
        var correlationId = req.GetCorrelationId();
               ...
               }))
        {
            try
            {
                ...
                var finances = await _db.GetExpenditure(urn, dimension);
                return finances == null
                    ? new NotFoundResult()
                    : new JsonContentResult(finances);
            }
    ...
    public async Task<IActionResult> SchoolExpenditureHistoryAsync(
        [HttpTrigger(AuthorizationLevel.Admin, "get", Route = "school/{urn}/expenditure/history")]
        HttpRequest req,
        string urn)
    {
        var correlationId = req.GetCorrelationId();
