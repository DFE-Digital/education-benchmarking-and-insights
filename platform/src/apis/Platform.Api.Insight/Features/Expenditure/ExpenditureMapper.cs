...
public static class ExpenditureMapper
{
    ...
    public static ExpenditureHistoryResponse MapToApiResponse(this IEnumerable<ExpenditureHistoryModel> models, int startYear, int endYear)
    {
