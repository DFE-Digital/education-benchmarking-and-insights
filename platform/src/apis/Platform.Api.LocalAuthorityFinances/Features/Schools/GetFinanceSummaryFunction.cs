...
public class GetFinanceSummaryFunction(ISchoolsService service, IValidator<FinanceSummaryParameters> validator)
{
    ...
    [OpenApiParameter("dimension", In = ParameterLocation.Query, Description = "Dimension for resultant values", Type = typeof(string), Required = true, Example = typeof(ExampleDimensionFinance))]
    ...
    [OpenApiParameter("overallPhase", In = ParameterLocation.Query, Description = "Phase to filter resultant values", Type = typeof(string), Required = false, Example = typeof(ExampleOverallPhase))]
    ...
    [OpenApiResponseWithBody(HttpStatusCode.OK, ContentType.ApplicationJson, typeof(FinanceSummaryResponse[]))]
    [OpenApiResponseWithBody(HttpStatusCode.BadRequest, ContentType.ApplicationJson, typeof(ValidationError[]))]
    [OpenApiResponseWithoutBody(HttpStatusCode.NotFound)]
    public async Task<HttpResponseData> RunAsync(
        [HttpTrigger(AuthorizationLevel.Admin, MethodType.Get, Route = Routes.Finance)] HttpRequestData req,
        string code,
        CancellationToken cancellationToken = default)
    {
        var queryParams = req.GetParameters<FinanceSummaryParameters>();
