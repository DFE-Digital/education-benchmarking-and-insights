...
public class GetLocalAuthorityFunction(IVersionedHandlerDispatcher<IGetLocalAuthorityHandler> dispatcher) : VersionedFunctionBase<IGetLocalAuthorityHandler>(dispatcher)
{
