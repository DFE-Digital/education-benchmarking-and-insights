...
public class QueryHighNeedsFunction(IEnumerable<IQueryHighNeedsHandler> handlers) : VersionedFunctionBase<IQueryHighNeedsHandler, BasicContext>(handlers)
{
    ...
    [OpenApiDimensionParameter(Required = false, Example = typeof(OpenApiExamples.DimensionHighNeeds))]
    [OpenApiSubmissionTypeParameter(Required = false, Example = typeof(OpenApiExamples.TypeHighNeeds))]
