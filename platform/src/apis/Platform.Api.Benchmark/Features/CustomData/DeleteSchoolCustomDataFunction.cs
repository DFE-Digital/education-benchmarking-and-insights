...
public class GetCustomDataFunction(ILogger<GetCustomDataFunction> logger, ICustomDataService service)
{
    [Function(nameof(CreateSchoolCustomDataAsync))]
    [OpenApiOperation(nameof(CreateSchoolCustomDataAsync), Constants.Features.CustomData)]
