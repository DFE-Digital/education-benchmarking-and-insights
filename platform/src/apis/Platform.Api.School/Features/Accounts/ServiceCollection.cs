...
public static class ServiceCollection
{
    public static IServiceCollection AddAccountsFeature(this IServiceCollection serviceCollection)
    {
        serviceCollection
            ...
            .AddSingleton<IGetIncomeNationalAverageHistoryHandler, GetIncomeNationalAverageHistoryV1Handler>()
            .AddSingleton<IGetBalanceHandler, GetBalanceV1Handler>()
            .AddSingleton<IGetBalanceHistoryHandler, GetBalanceHistoryV1Handler>()
            .AddSingleton<IGetBalanceComparatorSetAverageHistoryHandler, GetBalanceComparatorSetAverageHistoryV1Handler>()
            .AddSingleton<IGetBalanceNationalAverageHistoryHandler, GetBalanceNationalAverageHistoryV1Handler>()
            ...
            .AddTransient<IValidator<BalanceParameters>, BalanceParametersValidator>()
            .AddTransient<IValidator<IncomeNationalAvgParameters>, IncomeNationalAvgParametersValidator>()
            .AddTransient<IValidator<BalanceNationalAvgParameters>, BalanceNationalAvgParametersValidator>()
