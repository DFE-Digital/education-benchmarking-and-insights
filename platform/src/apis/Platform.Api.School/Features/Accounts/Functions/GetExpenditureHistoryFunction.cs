...
public class GetExpenditureHistoryFunction(IEnumerable<IGetExpenditureHistoryHandler> handlers) : VersionedFunctionBase<IGetExpenditureHistoryHandler, IdContext>(handlers)
{
