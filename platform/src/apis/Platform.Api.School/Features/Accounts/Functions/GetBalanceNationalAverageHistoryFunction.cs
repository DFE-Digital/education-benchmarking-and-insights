...
public class GetBalanceNationalAverageHistoryFunction(IEnumerable<IGetBalanceNationalAverageHistoryHandler> handlers) : VersionedFunctionBase<IGetBalanceNationalAverageHistoryHandler, BasicContext>(handlers)
{
    ...
    [OpenApiOperation(nameof(GetBalanceNationalAverageHistoryFunction), Constants.Features.Accounts)]
    ...
    public async Task<HttpResponseData> RunAsync(
        [HttpTrigger(AuthorizationLevel.Admin, MethodType.Get, Route = Routes.BalanceNationalAverageHistory)] HttpRequestData req,
