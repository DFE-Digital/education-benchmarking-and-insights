...
public class GetItSpendingForecastFunction(IEnumerable<IGetItSpendingForecastHandler> handlers) : VersionedFunctionBase<IGetItSpendingForecastHandler, IdContext>(handlers)
{
