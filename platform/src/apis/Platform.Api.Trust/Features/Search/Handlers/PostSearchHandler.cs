...
public class PostSearchV1Handler(ITrustSearchService service,
    [FromKeyedServices(nameof(SearchFeature))] IValidator<SearchRequest> validator) : IPostSearchHandler
{
