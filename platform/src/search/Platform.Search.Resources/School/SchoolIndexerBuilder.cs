    ...
    public override async Task Build(SearchIndexerClient client)
    {
            ...
            targetIndexName: ResourceNames.Search.Indexes.School)
        {
            FieldMappings =
            {
                ...
                new FieldMapping("AddressStreet") { TargetFieldName = nameof(SchoolIndex.AddressStreetNGram) },
                new FieldMapping("AddressLocality") { TargetFieldName = nameof(SchoolIndex.AddressLocalityNGram) },
                new FieldMapping("AddressLine3") { TargetFieldName = nameof(SchoolIndex.AddressLine3NGram) },
                new FieldMapping("AddressTown") { TargetFieldName = nameof(SchoolIndex.AddressTownNGram) },
                new FieldMapping("AddressCounty") { TargetFieldName = nameof(SchoolIndex.AddressCountyNGram) },
                new FieldMapping("AddressPostcode") { TargetFieldName = nameof(SchoolIndex.AddressPostcodeNGram) },
