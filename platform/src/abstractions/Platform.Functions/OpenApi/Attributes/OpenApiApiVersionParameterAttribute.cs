...
{
    public OpenApiApiVersionParameterAttribute(string name = Constants.ApiVersion, ParameterLocation location = ParameterLocation.Header, bool isRequired = false) : base(name)
    {
        Type = typeof(string);
