...
{
    public OpenApiFinanceTypeParameterAttribute(string name = "financeType", ParameterLocation location = ParameterLocation.Query, bool isRequired = false) : base(name)
    {
        Type = typeof(string);
