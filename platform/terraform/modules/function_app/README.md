...
| <a name="input_networking"></a> [networking](#input\_networking) | n/a | <pre>object({<br/>    enable_restrictions = bool<br/>    subnet_ids          = list(string)<br/>    join_subnet_id      = optional(string, "")<br/>  })</pre> | n/a | yes |
