...
| <a name="input_configuration"></a> [configuration](#input\_configuration) | n/a | <pre>map(object({<br>    search_sku            = string<br>    search_replica_count  = number<br>    sql_telemetry_enabled = bool<br>  }))</pre> | <pre>{<br>  "automated-test": {<br>    "search_replica_count": 1,<br>    "search_sku": "basic",<br>    "sql_telemetry_enabled": false<br>  },<br>  "development": {<br>    "search_replica_count": 1,<br>    "search_sku": "basic",<br>    "sql_telemetry_enabled": true<br>  },<br>  "feature": {<br>    "search_replica_count": 1,<br>    "search_sku": "basic",<br>    "sql_telemetry_enabled": true<br>  },<br>  "pre-production": {<br>    "search_replica_count": 1,<br>    "search_sku": "basic",<br>    "sql_telemetry_enabled": false<br>  },<br>  "production": {<br>    "search_replica_count": 3,<br>    "search_sku": "basic",<br>    "sql_telemetry_enabled": false<br>  },<br>  "test": {<br>    "search_replica_count": 1,<br>    "search_sku": "basic",<br>    "sql_telemetry_enabled": false<br>  }<br>}</pre> | no |
