---
title: Rounding Off Rules In Service
layout: sub-navigation
sectionKey: Reference
includeInBreadcrumbs: true
eleventyNavigation:
  key: Rounding Off Rules In Service
...
![Currency rounding example](/assets/images/developers/Table-rounded-to-nearest-£.png)

### Currency Rounding in Charts (k Format)

![Currency k-format example](/assets/images/developers/charts-rounded-to-K-format.png)

### Percentage Rounding (1 Decimal Place)

![Percentage rounding example](/assets/images/developers/chart-percentage-rounding.png)

### Ratio Rounding (2 Decimal Places)

![Ratio rounding example](/assets/images/developers/chart-ratio-rounding.png)
...
![Small value misalignment screenshot](/assets/images/developers/chart-showing-potential-issue-with-rounding.png)
