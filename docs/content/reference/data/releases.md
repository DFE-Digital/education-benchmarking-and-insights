...
For detailed payload schema definitions, optional parameters, and custom run examples, please refer to the [Pipeline Payload Definitions and Schema Nuances](./pipeline-trigger-message.md) reference page.
