...
For detailed payload schema definitions, optional parameters, and custom run examples, please refer to the [Pipeline Payload Definitions and Schema Nuances](./13_Pipeline-Trigger-Message.md) reference page.
