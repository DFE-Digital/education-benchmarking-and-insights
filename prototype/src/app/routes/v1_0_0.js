...
console.log('here - routes v1');
    ...
    res.render( version + '/find-school', { schools: schools, trusts: trusts, authorities: authorities } );
})
...
router.get( '/comparators/view', (req, res) => {
    ...
    res.render( version + '/comparators/view', { pupilRows: pupilRows, buildingRows: buildingRows } );
})
...
router.get( '/comparators/create/view', (req, res) => {
    ...
    res.render( version + '/comparators/create/view', { schoolRows: schoolRows, rows: rows, confirmation: req.session.data['confirmation'], comparatorSetType: req.session.data['comparatorSetType'], errorThisPage: req.session.data['errorThisPage'], errorNoSchool: req.session.data['errorNoSchool'] } );
...
router.get( '/comparators/reset-confirmed', (req, res) => {
    ...
    res.render( version + '/school-homepage', {confirmation: 'comparator-reset' } );
...
router.get( '/comparators', (req, res) => {
    ...
    res.render( version + '/comparators/index', { confirmation: req.session.data['confirmation'] } );
...
router.get( '/comparators/view-school', (req, res) => {
    ...
    res.render( version + '/comparators/view-school', { comparatorName: objSchool.comparatorName, comparatorLocation: objSchool.comparatorLocation, comparatorPostcode: objSchool.comparatorPostcode, comparatorPupils: objSchool.comparatorPupils.toLocaleString(), comparatorMeals: objSchool.comparatorMeals }  );
})
...
router.get( '/compare-trusts/view', (req, res) => {
    ...
    res.render( version + '/compare-trusts/view', { trustRows: trustRows, rows: rows, confirmation: req.session.data['confirmation'], trustSetType: req.session.data['trustSetType'], errorThisPage: req.session.data['errorThisPage'], errorNoSchool: req.session.data['errorNoSchool'] } );
...
router.get( '/custom-data/generated', (req, res) => {
    ...
    res.render( version + '/custom-data/custom-homepage', {confirmation: 'generated' } );
...
router.get( '/custom-data/updated', (req, res) => {
    console.log('here');
    req.session.data['customData'] = 'generated';
    res.render( version + '/custom-data/custom-homepage', {confirmation: 'updated' } );
