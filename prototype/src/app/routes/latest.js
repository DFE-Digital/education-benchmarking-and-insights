...
router.get("/comparators/view", (req, res) => {
    ...
    pupilRows.push([
      {
        html:
          "<strong>" +
          req.session.data["school-name"] +
          '</strong><br /><span class="govuk-hint">(Your chosen school)</span>',
      },
      { text: "Secondary" },
      { text: "1,408" },
      { text: "12.7%" },
  ...
  if (buildingComparators) {
    ...
    if (req.session.data["signedIn"] == "true") {
      ...
      buildingRow.push({
        html: '<a href="/sign-in?goTo=/comparators/view&hash=\&building">Sign in</a> to see',
        colspan: 2,
