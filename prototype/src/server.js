...
const { expressNunjucks, getNunjucksAppEnv, stopWatchingNunjucks } = require('govuk-prototype-kit/lib/nunjucks/nunjucksConfiguration')
...
// Local dependencies
const { projectDir, packageDir, appViewsDir, finalBackupNunjucksDir } = require('govuk-prototype-kit/lib/utils/paths')
const config = require('govuk-prototype-kit/lib/config.js').getConfig()
const packageJson = require('./package.json')
const { govukFrontendPaths } = require('govuk-prototype-kit/lib/govukFrontendPaths')
const utils = require('govuk-prototype-kit/lib/utils')
const sessionUtils = require('govuk-prototype-kit/lib/session.js')
const plugins = require('govuk-prototype-kit/lib/plugins/plugins.js')
const routesApi = require('govuk-prototype-kit/lib/routes/api.js')
...
app.use(require('govuk-prototype-kit/lib/authentication.js')())
...
require('govuk-prototype-kit/lib/manage-prototype-routes.js')
require('./plugins-routes.js')
const { getErrorModel } = require('govuk-prototype-kit/lib/utils/errorModel')
