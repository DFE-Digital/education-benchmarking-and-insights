...
} = require("govuk-prototype-kit/lib/nunjucks/nunjucksConfiguration");
...
} = require("govuk-prototype-kit/lib/utils/paths");
const config = require("govuk-prototype-kit/lib/config.js").getConfig();
const packageJson = require("./package.json");
const {
  govukFrontendPaths,
} = require("govuk-prototype-kit/lib/govukFrontendPaths");
...
app.get("/", async (req, res) => {
  const starterHomepageCode = await fsp.readFile(
    path.join(packageDir, "prototype-starter", "app", "views", "index.njk"),
    "utf8"
  );
