...
Three rounding rules are applied depending on:

- Whether the value contains decimals
- Whether the value is a **currency** or a **percentage**
...
- If the value is **1000 or greater**, charts convert it to a **“k” format**, rounded to **one decimal place**.
...
- This applies to **both table and chart views**.
- No “k” formatting is ever applied to percentages.
...
### Visual Misalignment for Very Small Currency Values (e.g., 0 → 0.5)
...
- Applying similar visual‑consistency rules to percentage bars if needed
