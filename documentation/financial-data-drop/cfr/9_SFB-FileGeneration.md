...
1. Meticulously  edit all five (5) sql scripts copied over from last academic reporting year's folder to the newly created academic reporting year's folder as mentioned under Prerequisite subsection in documentation [Overview](documentation\financial-data-drop\cfr\1_Overview .md) page. Edits must reflect
...
3. Export all record in `[CFR25].[dbo].[SFB_Maintained_2024-25]`, save as `maintained_schools_master_list.csv` in the newly created academic reporting year's folder within Azure blob storage as mentioned under Prerequisite subsection in documentation [Overview](documentation\financial-data-drop\cfr\1_Overview .md) page.
