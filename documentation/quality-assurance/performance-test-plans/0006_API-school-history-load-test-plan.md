...
| Insights | `GET /census/{urn}/history`                                    | Peak    | 40 /s             | S2      |
| Insights | `GET /census/history/national-average`                         | Peak    | 40 /s             | S2      |
| Insights | `GET /census/{urn}/history/comparator-set-average`             | Peak    | 40 /s             | S2      |
