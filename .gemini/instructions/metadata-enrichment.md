...
- **Mandatory Discovery Rules**: Read and follow the discovery and validation rules in `md` to resolve the `<api_name>` and `<feature_name>` to a specific directory path (e.g., `../../platform/src/apis/Platform.Api.School/Features/Search`).
