...
public record ExpenditureHistoryRows
{
...
public abstract record ItExpenditure
{
...
public record SchoolItExpenditure : ItExpenditure, IEqualityComparer<SchoolItExpenditure>
{
    public string? URN { get; set; }
    public string? SchoolName { get; set; }
    public string? SchoolType { get; set; }
    ...
    public bool Equals(SchoolItExpenditure? x, SchoolItExpenditure? y)
    {
    ...
    public int GetHashCode(SchoolItExpenditure obj)
    {
