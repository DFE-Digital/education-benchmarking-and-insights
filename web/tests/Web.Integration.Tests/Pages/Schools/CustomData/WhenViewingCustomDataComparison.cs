...
public class WhenViewingCustomDataComparison(SchoolBenchmarkingWebAppClient client)
    : PageBase<SchoolBenchmarkingWebAppClient>(client)
{
    ...
    public async Task CanDisplayNotFound()
    {
        ...
        var page = await Client.SetupEstablishmentWithNotFound()
            ...
            .Navigate(Paths.SchoolComparisonCustomData(urn));

        PageAssert.IsNotFoundPage(page);
        DocumentAssert.AssertPageUrl(page, Paths.SchoolComparisonCustomData(urn).ToAbsolute(), HttpStatusCode.NotFound);
    }
    ...
    public async Task CanDisplayProblemWithService()
    {
        ...
        DocumentAssert.AssertPageUrl(page, Paths.SchoolComparisonCustomData(urn).ToAbsolute(), HttpStatusCode.InternalServerError);
    }
    ...
    private async Task<(IHtmlDocument page, School school)> SetupNavigateInitPage(bool withUserData)
    {
        ...
        if (withUserData)
        {
            page = await Client.SetupEstablishment(school)
                ...
                .Navigate(Paths.SchoolComparisonCustomData(school.URN));
        }
        else
        {
            page = await Client.SetupEstablishment(school)
