    ...
    : WebAppClientBase<Program>(messageSink, authCfg)
{
    ...
    private void EnableFeatures(params string[] ignoreFeatures)
    {
        var features = new[]
        {
            ...
            FeatureFlags.SeniorLeadership,
            FeatureFlags.SchoolComparisonFilter,
            FeatureFlags.LocalAuthorityRiskIndicators
        };
    ...
    public BenchmarkingWebAppClient SetupSchoolInsight(School school, SchoolCharacteristic? characteristic = null)
    {
        SchoolInsightApi.Reset();
        SchoolInsightApi
            .Setup(api => api.GetCharacteristicsAsync(school.URN ?? "", It.IsAny<CancellationToken>()))
    ...
    public BenchmarkingWebAppClient SetupComparatorSet(Trust trust, UserDefinedSchoolComparatorSet? comparatorSet)
    {
        ComparatorSetApi.Reset();
        ComparatorSetApi.Setup(api => api.GetUserDefinedTrustAsync(trust.CompanyNumber!, It.IsAny<string>(), It.IsAny<CancellationToken>())).ReturnsAsync(ApiResult.Ok(comparatorSet));
        return this;
    }
    ...
    public BenchmarkingWebAppClient SetupSchool(
        ...
        IncomeHistoryRows? incomeHistorySchool = null,
        IncomeHistoryRows? incomeHistoryComparatorSet = null,
        ...
        BalanceHistoryRows? balanceHistoryNational = null)
    {
        ...
        SchoolApi.Setup(api => api.QueryIncomeHistoryAsync(It.IsAny<string>(), It.IsAny<ApiQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(ApiResult.Ok(incomeHistorySchool));
        SchoolApi.Setup(api => api.QueryIncomeComparatorSetAverageHistoryAsync(It.IsAny<string>(), It.IsAny<ApiQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(ApiResult.Ok(incomeHistoryComparatorSet));
        SchoolApi.Setup(api => api.QueryIncomeNationalAverageHistoryAsync(It.IsAny<ApiQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(ApiResult.Ok(incomeHistoryNational));
