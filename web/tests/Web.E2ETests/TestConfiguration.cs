...
public static class TestConfiguration
{
    ...
    public static string LoginEmail => Instance.GetValue<string>("LoginEmail") ?? throw new Exception("Login email is missing");
    public static string LoginPassword => Instance.GetValue<string>("LoginPassword") ?? throw new Exception("Login password is missing");
