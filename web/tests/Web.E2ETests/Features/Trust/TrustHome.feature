Feature: Trust homepage
    ...
    Scenario: View RAG ratings for cost categories in trust
        ...
        Then I can see the following RAG ratings for cost categories in the trust:
          | Name                                       | Status                                                                               |
          | Catering staff and supplies                | 2 high, 0 medium and 0 low for Catering staff and supplies                |
          | Premises staff and services                | 2 high, 0 medium and 0 low for Premises staff and services                |
          | Non-educational support staff and services | 1 high, 1 medium and 0 low for Non-educational support staff and services |
          | Teaching and Teaching support staff        | 1 high, 1 medium and 0 low for Teaching and Teaching support staff        |
          | Administrative supplies                    | 1 high, 0 medium and 1 low for Administrative supplies                    |
          | Educational supplies                       | 1 high, 0 medium and 1 low for Educational supplies                       |
          | Educational ICT                            | 0 high, 2 medium and 0 low for Educational ICT                            |
          | Utilities                                  | 0 high, 1 medium and 1 low for Utilities                                  |

    Scenario: View RAG ratings for schools in trust
        Given I am on trust homepage for trust with company number '08104190'
        Then I can see the following RAG ratings for schools in the trust:
          | Name                    | Status                                                            |
          | Test academy school 319 | 6 high, 2 medium and 0 low for Test academy school 319 |
          | Test academy school 87  | 2 high, 3 medium and 3 low for Test academy school 87  |
