Feature: Trust benchmark IT spending
    ...
    Background:
        ...
        And I have no previous comparators selected for company number '00000002'
        And I am on IT spend for trust with company number '00000002'
    ...
    Scenario: Can view IT spending
        Then the IT spend for trust page for company number '00000002' is displayed
    ...
    Scenario: Benchmark IT spending page directs to login page when not logged in
        ...
        When When I navigate to the trust Benchmark IT spending URL with company number '00000002'
        Then I should be redirected to the sign-in page
        
    Scenario: Clicking trust name in chart directs to homepage
        Given I am on it spend page for trust with company number '00000002'
