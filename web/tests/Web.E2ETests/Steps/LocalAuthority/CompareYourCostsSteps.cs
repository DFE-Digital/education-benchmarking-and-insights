...
[Binding]
[Scope(Feature = "Local Authority compare your costs")]
public class CompareYourCostsSteps(PageDriver driver)
{
    ...
    [Given("I am on compare your costs page for local authority with code '(.*)'")]
    public async Task GivenIAmOnCompareYourCostsPageForLocalAuthorityWithCode(string laCode)
    {
        var url = CompareYourCostsUrl(laCode);
    ...
    private static string CompareYourCostsUrl(string urn) => $"{TestConfiguration.ServiceUrl}/local-authority/{urn}/comparison";
}