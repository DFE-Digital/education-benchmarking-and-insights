...
public class WhenViewingSchoolFinancialPlanningTotalTeacherCost(WebDriver driver, ITestOutputHelper outputHelper) : PageBase(outputHelper), IClassFixture<WebDriver>
{
    [Fact]
