...
public class WhenViewingSchoolFinancialPlanningTotalIncome(WebDriver driver, ITestOutputHelper outputHelper) : PageBase(outputHelper), IClassFixture<WebDriver>
{
    [Fact]
