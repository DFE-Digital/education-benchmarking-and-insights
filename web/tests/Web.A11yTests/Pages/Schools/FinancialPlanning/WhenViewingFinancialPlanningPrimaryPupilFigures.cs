...
public class WhenViewingFinancialPlanningPrimaryPupilFigures(
    ITestOutputHelper outputHelper,
    WebDriver webDriver,
    FinancialPlanMinimalDataFixture plan)
    : PageBase(outputHelper, webDriver)
{
    protected override string PageUrl => $"/school/{plan.Urn}/financial-planning/create/primary-pupil-figures?year={plan.Year}";
