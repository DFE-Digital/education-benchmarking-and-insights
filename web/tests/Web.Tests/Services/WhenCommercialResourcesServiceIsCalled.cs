...
public class WhenCommercialResourcesServiceIsCalled
{
    ...
    [Fact]
    public async Task GetResourcesShouldReturnCachedResponseIfItExist()
    {
    ...
    [Fact]
    public async Task GetResourcesShouldSetCacheCorrectlyIfItDoesNotExist()
    {
        var (mockCache, options) = CreateCacheAndOptions();
    ...
    [Fact]
    public async Task GetResourcesShouldCallApiWhenCacheDoesNotExist()
    {
        var (mockCache, options) = CreateCacheAndOptions();
