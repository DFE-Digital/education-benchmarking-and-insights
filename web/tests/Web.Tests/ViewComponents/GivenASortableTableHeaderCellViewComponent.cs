...
public class SortableTableHeaderCellViewComponentTests
{
    ...
    public void ShouldReturnPassThroughValuesForLink()
    {
        ...
        var model = result.ViewData?.Model as SortableTableHeaderCellLinkViewModel;
    ...
    [Theory]
    [InlineData("testField", "sortKey", "~", "testField", "asc", "other=value", "?other=value&sortKey=testField~desc")]
    [InlineData("testField", "sortKey", "~", "testField", "desc", "other=value", "?other=value&sortKey=testField~asc")]
    [InlineData("testField", "sortKey", "~", null, null, "other=value", "?other=value&sortKey=testField~asc")]
    [InlineData("testField", "sortKey", "~", null, null, null, "?sortKey=testField~asc")]
    [InlineData("testField", "sortKey", "~", "otherField", "asc", null, "?sortKey=testField~asc")]
    public void ShouldGenerateHrefWithSortFieldAndSortOrderForLink(string sortField, string sortKey, string sortDelimeter, string? currentSortField, string? currentSortOrder, string? baseQuery, string expectedQueryString)
    {
        // arrange
        const string label = nameof(label);
    ...
    public void ShouldReturnCurrentSortForFieldForLink(string sortField, string sortKey, string sortDelimeter, string? currentSortField, string? currentSortOrder, string? expectedSort)
    {
        // arrange
        const string label = nameof(label);
        var queryValues = new Dictionary<string, StringValues>();
    ...
    public void ShouldReturnCurrentAriaSortForFieldForLink(string sortField, string sortKey, string sortDelimeter, string? currentSortField, string? currentSortOrder, string? expectedAriaSort)
    {
        // arrange
        const string label = nameof(label);
        var queryValues = new Dictionary<string, StringValues>();
    ...
    public void ShouldGenerateSortValueWithSortFieldAndSortOrderForButton(string sortField, string sortKey, string sortDelimeter, string? currentSortField, string? currentSortOrder, string? baseQuery, string expectedSortValue)
    {
        // arrange
        const string label = nameof(label);
        var queryValues = new Dictionary<string, StringValues>();
        ...
        // act
        var result = _component.Invoke(label, sortField, sortKey, sortDelimeter, true) as ViewViewComponentResult;
    ...
    [InlineData("testField", "sortKey", "~", null, null, null)]
    [InlineData("testField", "sortKey", "~", "otherField", "asc", null)]
    public void ShouldReturnCurrentSortForFieldForButton(string sortField, string sortKey, string sortDelimeter, string? currentSortField, string? currentSortOrder, string? expectedSort)
    {
        // arrange
        const string label = nameof(label);
        var queryValues = new Dictionary<string, StringValues>();
